...
public class Form2Presenter extends BasePresenter<Form2View> {
    ...
    public void saveForm(JsonObject jsonObject) {
        ...
        if (!NetworkUtils.isNetworkConnected(mvpView.getContext())) {
            ...
            addSubscription(apiStores.addGoatsAvailableBeneficiaryMTGMember(jsonObject), new ApiCallback <FormSubmitResponse>() {
    ...
    public void getFormRecordData(JsonObject jsonObject) {
        ...
        if (!NetworkUtils.isNetworkConnected(mvpView.getContext())) {
            ...
            addSubscription(apiStores.getForm2Data(jsonObject), new ApiCallback <RetrivedDataResponse>() {
                @Override
