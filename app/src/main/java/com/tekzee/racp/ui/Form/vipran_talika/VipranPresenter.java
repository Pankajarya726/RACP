...
public class VipranPresenter extends BasePresenter<VipranView> {


    public VipranPresenter(VipranView vipranView) {

        attachView(vipranView);
    }
    ...
    public void getAnimalType() {
        ...
        if (!NetworkUtils.isNetworkConnected(mvpView.getContext())) {
            ...
            addSubscription(apiStores.getAnimalTypeByCategory(1), new ApiCallback <JsonObject>() {
                @Override
                public void onSuccess(JsonObject successResult) {
    ...
    public void saveForm(JsonObject json) {
        ...
        if (!NetworkUtils.isNetworkConnected(mvpView.getContext())) {
            ...
            addSubscription(apiStores.addVipananTalika(json), new ApiCallback <FormSubmitResponse>() {
    ...
    public void getFormRecordData(JsonObject jsonObject) {
        ...
        if (!NetworkUtils.isNetworkConnected(mvpView.getContext())) {
            ...
            addSubscription(apiStores.getVipranTalikaData(jsonObject), new ApiCallback <RetrivedVipranTalikaResponse>() {
                @Override
                public void onSuccess(RetrivedVipranTalikaResponse successResult) {
